...
* 2. Implicit Binding - (objects generally) is used the most. When a function is envoked, look to the left of the dot and that is what the `this` keyworkd references.
* 3. New binding - used when you create a new object with the `new` keyword, the `this` keyword is bound to the new object.
* 4. Explicit Binding - (functions generally) you use it when you call a function with an argument using .call, .apply or .bind and the argument is the `this` statement reference.
*
